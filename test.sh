...
mkdir -p azureuser/.kube && rm -f azureuser/.kube/config && sudo cp -rf -i /etc/kubernetes/admin.conf azureuser/.kube/config && sudo chown azureuser:azureuser/.kube/config
